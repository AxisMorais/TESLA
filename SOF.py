...
class ExecutorCargaSOF:

    def executarCargaSOF():
        # ABRIR O NAVEGADOR
        ...
        # Escolhendo a carga SOF para ser ralizada:
        navegador.find_element(By.XPATH, '//*[@id="geral"]/div[2]/ul/li[5]/ul/li[4]/a').click()
...
meuObjetoTeste = ExecutorCargaSOF
for x in range(0, 1):
    try:
        meuObjetoTeste.executarCargaSOF()
    except:
        meuObjetoTeste.executarCargaSOF()
